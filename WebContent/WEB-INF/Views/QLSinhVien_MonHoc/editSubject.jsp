...
<t:WrapperAdmin>
	<div class="row">
		<div class="col-md-12">
		<form action="/WebThi/EditSubject" method ="post">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">
						<b> Chỉnh sữa môn học </b>
					</h3>
					<div class="card-body">
							...
							<div class="form-group row">
								...
								<input type="hidden" name="id" value="${subject.subjectID }">
									<input type="text" class="form-control" name="txtName" placeholder="Tên môn học" value="${subject.subjectName }">
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="txtFaculty"
										placeholder="Khoa giảng dạy" value="${subject.faculty }">
								</div>					
							</div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-4">
									<input type="number" class="form-control" id="credit" name="txtCredit" value="${subject.credit }">
						...
						<div class="col-8 my-1">
						      <div class="custom-control custom-checkbox mr-sm-2">
						      	...
						      	<c:if test="${ subject.activate eq 'true' }">
						        <input type="checkbox" class="custom-control-input" id="ckbActivate" name="ckbActivate" value="true" checked>
						        <label class="custom-control-label py-1" for="ckbActivate"><b>Kích hoạt </b></label>
						      </c:if>
						      <c:if test="${ subject.activate eq 'false' }">
						        <input type="checkbox" class="custom-control-input" id="ckbActivate" name="ckbActivate" value="false" >
						        <label class="custom-control-label py-1" for="ckbActivate"><b>Kích hoạt </b></label>
						      </c:if>
						      </div>
						    </div>
