...
<head>
  ...
  <title>Thi online trắc nghiệm</title>
          ...
          <div class="banner-text text-center">
            ...
            <div class="intro-para text-center quote">
              ...
              Nếu làm full sẽ được 10 điểm. Chọn một câu trả lời đúng.</p>
               <p class="big-text">Bắt đầu làm bài</p>
          ...
          <a href="http://www.creative-tim.com" class="simple-text logo-normal">
           <h4 style="color:blue;">Câu hỏi:</h4>
                   ...
                   <button type="button" class="btn btn-primary" style="width: 50px">1</button>
                    ...
                    <button type="button" class="btn btn-dark"style="width: 50px">5</button>
                    <button type="button" class="btn btn-dark"style="width: 50px">6</button>
                    <button type="button" class="btn btn-dark"style="width: 50px">7</button>
                    <button type="button" class="btn btn-dark"style="width: 50px">8</button>
                    <button type="button" class="btn btn-dark"style="width: 50px">9</button>
                    <button type="button" class="btn btn-dark"style="width: 50px">11</button>
                    <button type="button" class="btn btn-dark"style="width: 50px">12</button>
                    <button type="button" class="btn btn-dark"style="width: 50px">13</button>
                    <button type="button" class="btn btn-dark"style="width: 50px">14</button>
                    <button type="button" class="btn btn-dark"style="width: 50px">15</button>
                    <button type="button" class="btn btn-dark"style="width: 50px">16</button>
                    <button type="button" class="btn btn-dark"style="width: 50px">17</button>
                    <button type="button" class="btn btn-dark"style="width: 50px">18</button>
                    <button type="button" class="btn btn-dark"style="width: 50px">19</button>
                    <button type="button" class="btn btn-dark"style="width: 50px">20</button> 
        </div>
        <div class="row">
            <a href="trangxemketqua.jsp" style="color:blue">Finish attempt..</a>
           <h4 id="demo" style="color:blue;"> 0:30:16</h4>
         </a>
        </div> 
       </div>
