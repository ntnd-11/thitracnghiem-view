...
<body class="">
  ...
  <div class="content">
            ...
            <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <div class="row">
                      <div class="col-md-6">
                          <h3 class="card-title"><b> Chỉnh sửa câu hỏi: <i>124</i> </b> </h4>
                      </div>
                      <div class="col-md-3" >
                      </div>
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                  <div class="input-group mb-4">
                    ...
                    <textarea class="form-control p-2 my-2" rows="5" style="max-height:400px">C# ra đời vào năm bao nhiêu
                    </textarea>
                    <p> <b>Mức độ</b> </p>
                    ...
                    <div class="input-group">
                      <div class="input-group-text" style="border:none;background:none">
                          ...
                          Dễ
                          <input type="radio" checked="checked"name="radLevel" class="ml-2 mr-1" aria-label="Radio button for following text input">
                          Trung bình
                          <input type="radio" name="radLevel" class="ml-2 mr-1" aria-label="Radio button for following text input">
                          Khó
                      </div>
              ...
              <div class="card-footer">
                  <div class="input-group-text" style="border:none;background:none">
                      <input type="checkbox" checked="checked" radAns" class="mr-2" aria-label="Radio button for following text input">
                      Kích hoạt
                  </div>                  
              </div>
            </div>
                ...
                <ul class="nav flex-column" name="listAnswer">
                  <li class="nav-item">
                        <div class="input-group-text">
                          ...
                          <input type="text" class="form-control" aria-label="Text input with radio button" value="2000">
                        </div>
                  </li>
                  <li class="nav-item">
                      <div class="input-group-text">
                        <input type="radio" checked="checked" name="radAns" class="mr-2" aria-label="Radio button for following text input">
                        <input type="text" class="form-control" aria-label="Text input with radio button" value="2001">
                      </div>
                </li>
                  <li class="nav-item">
                      <div class="input-group-text">
                        <input type="radio" name="radAns" class="mr-2" aria-label="Radio button for following text input">
                        <input type="text" class="form-control" aria-label="Text input with radio button" value="1995">
                      </div>
                  </li>
                  <li class="nav-item">
                      <div class="input-group-text">
                        <input type="radio"  name="radAns" class="mr-2" aria-label="Radio button for following text input">
                        <input type="text" class="form-control" aria-label="Text input with radio button" value="1994">
                      </div>
                </li>
                </ul>
              </form>
        ...
        <div class="row justify-content-center">
          <a href="./listQuestion.html" class="btn btn-info col-3"> <i class="fa fa-save"></i> Lưu thay đổi</a>
          <a href="./listQuestion.html" class="btn btn-danger col-3"> <i class="fa fa-times"></i> Hủy </a>
        </div>
