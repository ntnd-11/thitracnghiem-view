...
<body class="">
  ...
  <div class="content">
                      ...
                      <div class="card-body">
                          <form>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" id="inputId" value="Lập trình web" placeholder="Tên môn học">
                                    </div>
                                  </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                      <input type="number" class="form-control" id="inputId" value="60">
                                    </div>
                                    <label for="inputId" class="col-sm-1 col-form-label"> <b> Phòng học </b></label>
                                    <div class="col-sm-5">
                                      <input type="text" class="form-control" id="inputId" placeholder="Phòng học" value="Phòng máy 1 TTTH">
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                      <label for="inputId" class="col-md-2 col-form-label"> <b> Ngày bắt đầu </b></label>
                                      <div class="col-md-4">
                                        <input type="date" class="form-control" id="inputId" value="2018-08-21"/> 
                                      </div>
                                      <label for="inputId" class="col-md-1 col-form-label"> <b> Ngày kết thúc </b></label>
                                      <div class="col-md-5">
                                        <input type="date" class="form-control" id="inputId" value="2018-12-15">
                                      </div>
                                    </div>
        ...
        <div class="row justify-content-center">
          <a href="./listSubject.html" class="btn btn-info col-3"> <i class="fa fa-check"></i> Lưu thay đổi</a>
          <a href="./listSubject.html" class="btn btn-danger col-3"> <i class="fa fa-times"></i> Hủy </a>
        </div>
